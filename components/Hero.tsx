...
const Hero = () => {
    ...
    const titles = ['Frontend Development', 'Backend Development', 'Fullstack Development', 'MERN stack Development'];
    ...
    return (
        <section id='home' className={`${theme === 'dark' && "bg-grey-900"} relative min-h-screen w-full mx-auto overflow-hidden`}>
            ...
            <div className="pt-16 lg:py-48 flex flex-col-reverse lg:flex-row justify-around gap-10 lg:gap-0">
                ...
                <div className="relative mx-auto lg:mx-0 mt-12 md:mt-16 lg:mt-0">
                    <div className="w-56 h-56 md:w-80 md:h-80 lg:-translate-x-16">
                        <Image alt='avatar' width={1000} height={1000} className="rounded-full w-full h-full object-cover" src='/images/heroImage.png' />
                    </div>
                    <div className="absolute grid -top-6 -left-12 lg:-top-14 lg:-left-32 w-16 h-16 p-0 md:w-20 md:h-20 bg-white dark:bg-grey-800 rounded-full place-items-center hover:shadow-lg transition-shadow">
                        <Image alt='tech-stack' className="h-10 w-10 md:h-12 md:w-12 object-cover" src='/tech_stack/react.png' width={200} height={200} />
                    </div>
                    <div className="absolute grid top-0 -right-12 lg:-right-4 w-14 h-14 bg-white dark:bg-grey-800 rounded-full place-items-center hover:shadow-lg transition-shadow">
                        <Image alt='tech-stack' className="h-8 w-8 md:h-10 md:w-10 object-cover" src='/tech_stack/node_js.webp' width={100} height={100} />
                    </div>
                    <div className="absolute grid bottom-[4rem] md:bottom-24 -right-16 md:-right-20 lg:bottom-[8.5rem] lg:-right-12 w-12 h-12 md:w-16 md:h-16 bg-white dark:bg-grey-800 rounded-full place-items-center hover:shadow-lg transition-shadow">
                        <Image alt='tech-stack' className="h-6 w-6 md:h-10 md:w-10 object-cover" src='/tech_stack/redux.webp' width={100} height={100} />
                    </div>
                    <div className="absolute grid -bottom-10 -right-8 lg:-bottom-0 lg:right-6 w-14 md:w-16 h-14 md:h-16 bg-white dark:bg-grey-800 rounded-full place-items-center hover:shadow-lg transition-shadow">
                        <Image alt='tech-stack' className="h-10 w-10 object-cover" src='/tech_stack/js.webp' width={100} height={100} />
                    </div>
                </div>
            ...
            {/* Stats */}
            <div className='pt-5 lg:pt-0 lg:py-0 flex flex-col-reverse lg:flex-row justify-around gap-10 lg:gap-0'>
                <div className='flex flex-col md:flex-row flex-wrap gap-4 md:gap-6 justify-center sm:w-[90%] lg:w-[80%] xl:w-[70%] mx-4 md:mx-6 xl:mx-0'>
                    <div className="flex flex-1 flex-col align-center xl:px-12 lg:px-8 px-4 py-6 rounded-md bg-violet-600 hover:bg-violet-700 dark:bg-violet-700 hover:dark:bg-violet-800 transition-colors group text-white">
                        <div className='h-12 w-12 self-center mb-4'>
                            <Image alt="Statistics" className='invert' src='/stat_1.png' width={100} height={100}/>
                        </div>
                        <br/>
                    ...
                    <div className="flex flex-1 flex-col align-center xl:px-12 lg:px-8 px-4 py-6 rounded-md bg-violet-600 hover:bg-violet-700 dark:bg-violet-700 hover:dark:bg-violet-800 transition-colors group text-white">
                        <div className='h-12 w-12 self-center mb-4'>
                            <Image alt="Statistics" className='invert' src='/stat_2.png' width={100} height={100}/>
                        </div>
                        <br/>
                        <p className='text-center mb-0 pb-0'>
                            <span className='text-4xl lg:text-5xl pb-0 font-bold '>
                    ...
                    <div className="flex flex-1 flex-col align-center xl:px-12 lg:px-8 px-4 py-6 rounded-md bg-violet-600 hover:bg-violet-700 dark:bg-violet-700 hover:dark:bg-violet-800 transition-colors group text-white">
                        <div className='h-12 w-12 self-center mb-4'>
                            <Image alt="Statistics" className='invert' src='/stat_4.png' width={100} height={100}/>
                        </div>
                        <br/>
                        <p className='text-center mb-0 pb-0'>
                            <span className='text-4xl lg:text-5xl pb-0 font-bold '>
                    ...
                    <div className="flex flex-1 flex-col align-center xl:px-12 lg:px-8 px-4 py-6 rounded-md bg-violet-600 hover:bg-violet-700 dark:bg-violet-700 hover:dark:bg-violet-800 transition-colors group text-white">
                        <div className='h-12 w-12 self-center mb-4'>
                            <Image alt="Statistics" className='invert' src='/stat_3.png' width={100} height={100}/>
                        </div>
                        <br/>
                        <p className='text-center mb-0 pb-0'>
                            <span className='text-4xl lg:text-5xl pb-0 font-bold '>
                            ...
                            <br/>
                            <span className='text-sm font-normal mb-0'>Lines of Code</span>
                        </p>
                    </div>
                </div>
